        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-10 grid grid-cols-12 gap-6 md:gap-8">
          ...
          <aside className="col-span-12 md:col-span-3">
            <div className="bg-white/90 backdrop-blur-xl border border-[#b428b4]/30 p-4 sm:p-6 shadow-2xl">
              ...
              {/* MOBILE TABBAR */}
              <div className="mt-4 flex md:hidden overflow-x-auto gap-2">
                {["overview", "myRepos", "publicRepos", "profiles"].map((tab) => (
                  <button
                    key={tab}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="p-4 sm:p-6 bg-gray-100/60 border border-[#b428b4]/20">
                    ...
                    {userRepo.length === 0 ? (
                      ...
                      userRepo
                        .slice()
                        .sort((a, b) => b.starred.length - a.starred.length)
                        .slice(0, 3)
                        .map((repo) => (
                          <div
                            key={repo._id}
                    ...
                    <div className="p-3 sm:p-4 border border-[#3023ae]/20">
                      ...
                      <p className="font-semibold text-gray-800">
                        {publicProfiles
                          ...
                          .sort(
                            (a, b) =>
                              (b.followingUser?.length || 0) -
                              (a.followingUser?.length || 0)
                          )[0]?.username || "No profiles yet"}
                      </p>
                    </div>
                  </div>
