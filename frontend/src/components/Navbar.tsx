        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* Square Profile Icon */}
              <div
                className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#ff006e]/20 to-[#00d9ff]/20 rounded-lg border border-[#ff006e]/30 hover:border-[#ff006e]/60 transition-all"
                style={{ cursor: "pointer" }}
                onClick={() => {
                  navigate("/profile");
                }}
